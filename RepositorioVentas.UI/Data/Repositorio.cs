...
using RepositorioVentas.UI.Data;
using RepositorioVentas.UI.BDContexto;

namespace RepositorioVentas.UI.Data
{
    ...
    public class Repositorio
    {
        ...
        List<Models.VentasInventario> ListaVenta;

        public Repositorio(RepositorioVentas.UI.BDContexto.BDContexto conexion, IMemoryCache cacheAcumulado, IMemoryCache cacheUsuarioIniciado, IMemoryCache elCache)
        {
            Conexion = conexion;
        ...
        {
            ListaVenta = new List<Models.VentasInventario>();
        ...
        {
            ListaVenta = (List<Models.VentasInventario>)ElCache.Get("Lista");
        ...
        public Models.Usuario ObtengaLosValoresDeCacheUsuarioIniciado()
        {
        ...
        public void GuardeUsuarioIniciado(Models.Usuario Usuario)
        {
        ...
        public void RegistreUsuarios(Models.Usuario Usuario)
        {
        ...
        public void RegistreInventario(Models.Inventario inventario)
        {
        ...
        public void RegistreVenta(Models.Ventas ventas)
        {
        ...
        public void ResteEnElInventarioTrasVenta(int id_venta) {
            ...
            ListaVenta = ElCache.Get<List<Models.VentasInventario>>("Lista");
        ...
        public void RegistreInventarioVenta(Models.VentasInventario ventas) {
        ...
        public List<Models.Inventario> ObtengaElInventario()
        {
            return Conexion.Inventarios.ToList();
        }

        public List<Models.AjusteDeInventario> ObtengaElAjusteDeInventario()
        {
            return Conexion.AjusteDeInventarios.ToList();
        }

        public List<Models.AjusteDeInventario> ObtengaLosAjustesPorInventario(int Id)
        {
            List<Models.AjusteDeInventario> listaDeAjustesSegunIdInventario;
        ...
        public Models.AjusteDeInventario ObtengaElAjustePorId(int Id)
        {
        ...
        public List<Models.Inventario> ObtengaLaListaPorNombre(string nombre)
        {
            List<Models.Inventario> listado_Del_Inventario_Segun_El_Nombre;
        ...
        public Models.Inventario ObtengaElInventarioPorId(int Id)
        {
        ...
        public void Edite(Models.Inventario inventario)
        {
            Models.Inventario productoPorModificar;
        ...
        public void EnviarEmailDeUsuarioRegistrado(Models.Usuario Usuario)
        {
        ...
        public void EnviarEmailDeInicioDeSesion(Models.Usuario Usuario)
        {
            string senderEmail = "lenguajesprueba2@gmail.com"; // Dirección de correo electrónico del remitente
            string senderPassword = "cujotnzioyjbmgzw"; // Contraseña de la cuenta de correo electrónico del remitente
            string recipientEmail = Usuario.Email; // Dirección de correo electrónico del destinatario
        ...
        public async Task EnviarEmailBloqueoUsuario(Models.Usuario usuario)
        {
            string senderEmail = "lenguajesprueba2@gmail.com"; // Dirección de correo electrónico del remitente
            string senderPassword = "cujotnzioyjbmgzw"; // Contraseña de la cuenta de correo electrónico del remitente
            string recipientEmail = usuario.Email; // Dirección de correo electrónico del destinatario
        ...
        public async Task EnviarEmailIntentoDeInicioDeSesionUsuarioBloqueado(Models.Usuario usuario)
        {
            string senderEmail = "lenguajesprueba2@gmail.com"; // Dirección de correo electrónico del remitente
            string senderPassword = "cujotnzioyjbmgzw"; // Contraseña de la cuenta de correo electrónico del remitente
            string recipientEmail = usuario.Email; // Dirección de correo electrónico del destinatario
        ...
        public Models.Usuario Validar(string UserName, string PasswordHash)
        {
            using (SHA256 sha256 = SHA256.Create())
            {
                byte[] bytes = Encoding.UTF8.GetBytes(PasswordHash);
        ...
        public string EncriptarClave(Models.Usuario usuario)
        {
        using (SHA256 sha256 = SHA256.Create())
        {
        ...
        public Models.Usuario EncontrarUsuario(string nombre, string clave)
        {
            ...
            if (Conexion.AspNetUsers != null)
            {
                var usuarioEncontrado = Conexion.AspNetUsers
                    ...
                    .Select(item => new Models.Usuario
                    {
        ...
        public Models.Usuario BuscarUsuarioPorId(Models.Usuario usuario)
        {
            var usuarioBuscado = Conexion.AspNetUsers.FirstOrDefault(u => u.Id == usuario.Id);
            return usuarioBuscado;
        }
        public Models.Usuario BuscarUsuariosRegistrados(string nombre)
        {
        ...
        public bool VerificarClave(Models.Usuario usuario, string claveIngresada)
        {
        ...
        public void EnviarEmailDeRestauracionDeClave(Models.Usuario Usuario)
        {
            string senderEmail = "lenguajesprueba2@gmail.com"; // Dirección de correo electrónico del remitente
        ...
        public Models.Usuario ContarInicioDeSesionFallidos(Models.Usuario usuario)
        {
        ...
        public Models.Usuario DesactivarBloqueo(Models.Usuario usuario)
        {
        ...
        public Models.Usuario EncontrarUsuarioPorNombre(string nombre)
        {
        ...
        public Models.Usuario ActualizarUsuario(Models.Usuario usuariomodificado)
        {
        ...
        public int ObtengaIdCaja()
        {
            ...
            if (Conexion.AperturasDeCaja != null)
            {
                var cajaAbierta = Conexion.AperturasDeCaja
                    ...
                    .Select(item => new Models.AperturaDeCaja
                    {
        ...
        public Models.Usuario BloquearUsuario(Models.Usuario usuario)
        {
            var usuarioBuscado = Conexion.AspNetUsers.FirstOrDefault(u => u.Id == usuario.Id);
        ...
        public bool RegistreAperturaCaja()
        {
            ...
            DateTime fechaHoraCR = TimeZoneInfo.ConvertTime(DateTime.Now, TimeZoneInfo.Local, zonaHorariaCR);
            ...
            if (usuarioIniciado != null)
            {
                ...
                aperturaDeCaja.FechaDeInicio = fechaHoraCR;
                aperturaDeCaja.Estado = Models.Estado.Abierta;

                Conexion.AperturasDeCaja.Add(aperturaDeCaja);
                Conexion.SaveChanges();

                acumuladoCaja.FechaDeInicio = fechaHoraCR;
        ...
        public void CierreAperturaCaja()
        {
            ...
            if (Conexion.AperturasDeCaja != null)
            {
                ...
                AperturaCaja.Estado = Models.Estado.Cerrada;
